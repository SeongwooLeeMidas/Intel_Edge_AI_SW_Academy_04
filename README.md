![20240618105802438760](https://github.com/user-attachments/assets/87089c17-f181-471e-a566-d1690e2e9c69)
...
---
- 객체지향 언어인 C++ 기반으로 제작한 [Color Image Processing - Github](https://github.com/SeongwooLeeMidas/Image_Processing_Project_Intel_04/tree/main/%EB%AF%B8%EB%8B%88%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8_Ver2_%EC%BD%94%EB%93%9C)
- OpenCV 없이 C++ 언어 기반으로 MFC를 사용한 GUI 환경에서 메모리 누수를 방지하는 기법을 활용해 다양한 화소 처리 알고리즘을 구현하고, 색상 변환을 통해 이미지 처리 성능을 향상시킨 디지털 영상 처리 시스템
...
### ✅ 프로젝트
- [전동 킥보드 불법 주정차 자동 관리 시스템 - Github](https://github.com/SeongwooLeeMidas/kick_cops_Vision_AI_Project.git)
- [전동 킥보드 불법 주정차 자동 관리 시스템 - Notion](https://mixed-makeup-d9d.notion.site/81748e0826a84213a6cdc7c0eafac202?pvs=4)
- 강서구 킥보드 빅데이터를 수집·분석하여 시각화하고, 주차 금지 구역에서의 체류 시간에 따른 조치를 하는 바른 주차 안내 시스템 구현
- 5월 22일 프로젝트 발표
...
|CNN|X|X|
|AI MATH|X|X|
|RNN|X|[6월 3일](https://mixed-makeup-d9d.notion.site/0603-RNN-54c2bc5f5e6c4cceaa4de7306c2b83f6?pvs=4)
|OpenVINO|X|[6월 4일](https://mixed-makeup-d9d.notion.site/0604-OpenVINO-789714f696d5475491bdfc8d4fbd84fd?pvs=4)
...
- 6/11 ~ 6/12 미니 프로젝트 진행 후 발표

### ✅ 교육 정리
|Content|Git|Day-Notion|
|------|---|---|
|아두이노 실습|X|[6월 13일](https://mixed-makeup-d9d.notion.site/0613-12f09779dc23493db155877db8c59b89?pvs=4)
|스마트 팩토리 실습 1|X|[6월 14일](https://mixed-makeup-d9d.notion.site/0614-4d826b4aeb544dc38dd6d87b7eea2fd3?pvs=4)
|스마트 팩토리 실습 2|X|[6월 17일](https://mixed-makeup-d9d.notion.site/0617-2-ddecac25b82c4377876399680e0d615e?pvs=4)

### ✅ 프로젝트
- [드론 객체 인식 및 추적 시스템 - Github](https://github.com/SeongwooLeeMidas/D-gaja_AI_Intel_Project)
- [드론 객체 인식 및 추적 시스템 - Notion](https://mixed-makeup-d9d.notion.site/DTS-89037e36d4894b45a5a09e315e251974?pvs=4)
- 웹캠으로 드론 영상을 받아 모터를 제어하여 드론을 감지 및 추적하여 신고하는 시스템입니다.
- 6/18 ~ 7/2 프로젝트 진행 후 발표
...
|Project|Git|Day-Notion|
|------|---|---|
|C 포인터, 배열|X|[7월 15일](https://mixed-makeup-d9d.notion.site/0715-3684f92f5fbd4fceae3df6a5ab65d3c0?pvs=4)
|컴파일, gcc, 디버깅|[GCC_Debuging](https://github.com/SeongwooLeeMidas/Intel_Edge_AI_SW_Academy_04/tree/main/SW_Architecture/0716_gcc_debuging)|[7월 16일](https://www.notion.so/0716-gcc-73ed647d5c204c9b803068a8ac79fe91?pvs=4)
|서버, 클라이언트 기반 소켓 통신|[File transfer with socket](https://github.com/SeongwooLeeMidas/Intel_Edge_AI_SW_Academy_04/tree/main/SW_Architecture/0717_File_transfer_with_socket)|[7월 17일](https://www.notion.so/0717-4f6c79cbd7e7438ca2ce1c73bec5ba94?pvs=4)
